...
import com.odisha_saraldata.scanner.OdishaPATScannerActivity;
import com.odisha_saraldata.scanner.SCANNER_TYPE;
...
public class RNOpenCvCameraModel extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    @ReactMethod
    void openOdishaScanCamera(String rollNumberList, String scannerType, Promise promise) throws JSONException {
        ...
        if(scannerType.equals(SCANNER_TYPE.PAT)) {
            intent = new Intent(activity, OdishaPATScannerActivity.class);
        }
